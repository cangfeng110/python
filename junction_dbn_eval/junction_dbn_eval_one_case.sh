...
main()
{
    ...
    rm $case_path/*~
    rm $case_path/*pred_output*
    rm $case_path/*brier_score*

    cd $run_path
    backup_files

    cd $curr_path
    python3 junction_dbn_eval_prepare_one_case.py --case-path $case_path \
    ...
    python3 junction_dbn_eval_one_case.py --case-path $case_path
